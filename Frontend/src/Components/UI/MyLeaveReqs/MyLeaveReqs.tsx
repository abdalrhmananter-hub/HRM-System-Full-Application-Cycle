            ...
            <div className="w-full max-w-[650px] bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm font-sans">
                ...
                <div className="w-full overflow-x-auto">
                    <table className="w-full text-left border-collapse min-w-[550px]">
                        {/* Table Head */}
                        <thead>
                            <tr className="bg-[#f7fafc] border-y border-gray-100 text-[#718096] text-[11px] font-bold tracking-wider uppercase">
                        ...
                        <tbody className="divide-y divide-gray-100 text-sm font-medium text-[#4a5568]">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td className="py-4 px-5 text-gray-600">Oct 24, 2023</td>
                                <td className="py-4 px-5 text-gray-600">Oct 28, 2023</td>
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td className="py-4 px-5 text-gray-600">Oct 23, 2023</td>
                                <td className="py-4 px-5 text-gray-600">Oct 23, 2023</td>
                                <td className="py-4 px-5 text-[#e53e3e] font-semibold">1 Day</td>
                                <td className="py-4 px-5">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td className="py-4 px-5 text-gray-600">Oct 20, 2023</td>
                                <td className="py-4 px-5 text-gray-600">Oct 21, 2023</td>
                                <td className="py-4 px-5 text-[#1a202c] font-semibold">2 Days</td>
                                <td className="py-4 px-5">
