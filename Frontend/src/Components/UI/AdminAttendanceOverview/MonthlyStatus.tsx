...
export default function MonthlyStatus() {
    return (
        <>
            <div className="w-[300px] bg-white border border-gray-200 rounded-2xl p-5 flex flex-col gap-5 shadow-sm font-sans">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="w-full bg-[#edf2f7] h-2 rounded-full overflow-hidden">
                        <div className={`bg-[#1e56a0] h-full rounded-full w-[${100}%]`}></div> {/* you can controll the precentage from w-[%]*/}
                    </div>
                </div>
