...
export default function RequestNewLeave() {
    return (
        <div className="w-full bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm font-sans">
            {/* Blue Header Banner */}
            <div className="bg-[#1e56a0] p-5 text-white flex flex-col gap-1.5">
                <h2 className="text-lg font-bold tracking-tight">Request New Leave</h2>
            ...
            <div className="p-5 flex flex-col gap-4">
                ...
                {/* Submit Button */}
                <button className="w-full bg-[#1e56a0] hover:bg-[#1a4b8c] text-white font-bold text-sm py-2.5 px-4 rounded-xl shadow-sm transition-colors mt-1">
                    Submit Request
                </button>
            </div>
        </div>
