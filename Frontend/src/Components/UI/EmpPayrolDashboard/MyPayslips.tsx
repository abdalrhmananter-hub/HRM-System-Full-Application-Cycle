            ...
            <div className="w-full max-w-[780px] bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm font-sans">
                ...
                <div className="flex justify-between items-center p-5">
                    <div className="flex flex-col gap-0.5">
                        <h2 className="text-[#1a202c] text-base font-bold">My Payroll History</h2>
                        <p className="text-[#718096] text-xs font-normal">View and download your monthly breakdown and payslips</p>
                    </div>

                    {/* Filter Period Button */}
                    <button className="flex items-center gap-2 px-3 py-1.5 border border-gray-200 rounded-xl text-xs font-semibold text-[#4a5568] hover:bg-gray-50 transition-colors">
                        ...
                        <tbody className="divide-y divide-gray-100 text-sm font-medium text-[#4a5568]">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td className="py-4 px-5 text-center">
                                    <button className="text-[#1e56a0] hover:bg-blue-50 p-2 rounded-xl transition-colors inline-flex items-center justify-center">
                ...
                <div className="flex justify-between items-center p-4 bg-white border-t border-gray-100">
                    ...
                    <div className="flex items-center gap-1">
                        <button className="w-7 h-7 flex items-center justify-center border border-gray-200 rounded-lg text-xs text-gray-400 cursor-not-allowed bg-gray-50">
