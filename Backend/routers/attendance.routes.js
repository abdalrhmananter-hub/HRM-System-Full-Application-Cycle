const { checkIn , checkOut , getAllAttendanceForEmp , attendanceSheetsForAllEmpForToday} = require('../controllers/attendance.controller');
...
router.get('/getAllAttendanceforAllempToday',attendanceSheetsForAllEmpForToday)
